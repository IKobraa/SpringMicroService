...
async function sendPrivateMessage() {
    ...
    try {
        ...
        const response = await fetch("https://roundhouse.proxy.rlwy.net:46083/send-private-message/" + email, {
            method: "POST",
            headers: {
...
async function saveMessages(msg,receiverEmail,senderEmail) {
    try {
    const response = await fetch("https://roundhouse.proxy.rlwy.net:46083/api/user/saveUserMessage", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
